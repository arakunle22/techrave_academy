          ...
          <div class="row g-0">
            <div class="col-12 col-md-6">
              <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy"
                src="./assets/img/logo-img-1.webp" alt="Welcome back you've been missed!">
            </div>
            <div class="col-12 col-md-6 d-flex align-items-center justify-content-center">
              <div class="col-12 col-lg-11 col-xl-10">
                <div class="card-body p-3 p-md-4 p-xl-5">
                  ...
                  <form action="register_user.php" method="POST">
                    <div class="row gy-3 overflow-hidden">
                      ...
                      <div class="col-12">
                      <div class="form-group form-floating" id="accessCodeField" style="display: none;">
                ...
                <input type="text" class="form-control" id="code" name="code">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <p class="mb-0 mt-5 text-secondary text-center">Already have an account? <a href="login.php"
