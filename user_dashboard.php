   ...
   <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #BD567F;">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto" style="gap: 20px;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#announcements" style="color: #FFFFFF; position: relative;">
                    ...
                    <?php if (isset($_SESSION['new_announcements']) && $_SESSION['new_announcements']): ?>
                        <sup style="position: absolute; top: -5px; right: -10px; background-color: red; color: white; font-size: 0.8rem; padding: 2px 5px; border-radius: 50%;">New</sup>
                    <?php endif; ?>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="modal" data-target="#profileModal" style="color: #FFFFFF;">
    ...
    <!-- Dashboard Content -->
    <div class="container">
    <section id="dashboard" class="section-header" style="background-color: #F9F9F9; padding: 40px 20px; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
    ...
    <p style="color: #333; font-size: 1.2rem;">
        <i class="fas fa-envelope"></i> Email: <span style="color: #BD577F;"><?= htmlspecialchars($user['email']); ?></span>
    </p>
</section>
    ...
    <div class="card-deck" style="display: flex; gap: 20px;">
        <div class="card" style="border: none; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
            <div class="card-body" style="background-color: #FFFFFF; border-radius: 10px; padding: 20px;">
                <h5 class="card-title" style="color: #BC547D; font-weight: bold; font-size: 1.5rem;">Introduction to Cybersecurity</h5>
                <p class="card-text" style="color: #777; font-size: 1rem;">Learn the basics of cybersecurity and how to protect yourself online.</p>
                <a href="#" class="btn" style="background-color: #BD577F; color: #FFFFFF; border-radius: 5px;">Start Course</a>
            </div>
        </div>
        <div class="card" style="border: none; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
            <div class="card-body" style="background-color: #FFFFFF; border-radius: 10px; padding: 20px;">
                <h5 class="card-title" style="color: #BC547D; font-weight: bold; font-size: 1.5rem;">Advanced Network Defense</h5>
                <p class="card-text" style="color: #777; font-size: 1rem;">Explore advanced techniques to secure networks from attacks.</p>
                <a href="#" class="btn" style="background-color: #BD577F; color: #FFFFFF; border-radius: 5px;">Continue Course</a>
            </div>
        </div>
        <div class="card" style="border: none; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
            <div class="card-body" style="background-color: #FFFFFF; border-radius: 10px; padding: 20px;">
                <h5 class="card-title" style="color: #BC547D; font-weight: bold; font-size: 1.5rem;">Cyber Threat Intelligence</h5>
                <p class="card-text" style="color: #777; font-size: 1rem;">Gain insights into cyber threats and how to mitigate them.</p>
                <a href="#" class="btn" style="background-color: #BD577F; color: #FFFFFF; border-radius: 5px;">View Details</a>
            </div>
        </div>
    </div>
</section>
...
<section id="announcements" class="section-header" style="padding: 40px; border-radius: 8px; background-color: #f9f9f9;">
    ...
    <div class="list-group" style="max-width: 800px; margin: 0 auto;">
        <?php foreach ($announcements as $announcement): ?>
            <a href="#" class="list-group-item list-group-item-action" style="background-color: #FFFFFF; border: 1px solid #E0E0E0; border-radius: 8px; margin-bottom: 15px; padding: 20px; color: #333333; position: relative; box-shadow: 0 2px 5px rgba(0,0,0,0.05); transition: transform 0.2s ease;">
                <div style="display: flex; align-items: center;">
                    <i class="fas fa-info-circle" style="color: #BD577F; margin-right: 15px;"></i>
                    <div>
                        <strong style="font-family: 'Helvetica Neue', sans-serif; font-size: 1.2rem; color: #333333;">
                            <?= htmlspecialchars($announcement['title']); ?>
                        </strong>
                        <p style="font-family: 'Arial', sans-serif; font-size: 1rem; margin: 5px 0 0; color: #555555;">
                            <?= htmlspecialchars($announcement['content']); ?>
                        </p>
                    </div>
                </div>
                <?php if (isset($announcement['is_new']) && $announcement['is_new']): ?>
                    <span style="position: absolute; top: 10px; right: 10px; background-color: #BC547D; color: #FFFFFF; padding: 5px 10px; border-radius: 12px; font-size: 0.9rem; font-family: 'Helvetica Neue', sans-serif;">
                        New
                    </span>
                <?php endif; ?>
            </a>
...
<section id="support" class="section-header" style="padding: 40px; border-radius: 8px;">
    <div style="text-align: center;">
        <h3 style="color: #333333; font-family: 'Helvetica Neue', sans-serif; font-weight: 700; margin-bottom: 20px;">
    ...
    <ul class="list-group" style="max-width: 600px; margin: 0 auto;">
        <li class="list-group-item" style="background-color: #FFFFFF; border: 1px solid #E0E0E0; border-radius: 5px; margin-bottom: 10px; padding: 15px; display: flex; align-items: center;">
            <i class="fas fa-envelope" style="color: #BD577F; margin-right: 15px;"></i>
            <span>Email: <a href="mailto:support@techraveictacademy.com" style="color: #333333; text-decoration: none;">support@techraveictacademy.com</a></span>
        </li>
        <li class="list-group-item" style="background-color: #FFFFFF; border: 1px solid #E0E0E0; border-radius: 5px; padding: 15px; display: flex; align-items: center;">
            <i class="fas fa-phone" style="color: #BD577F; margin-right: 15px;"></i>
            <span>Phone: <a href="tel:+1234567890" style="color: #333333; text-decoration: none;">+123-456-7890</a></span>
        </li>
    </ul>
</section>
